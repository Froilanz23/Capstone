...
@section('content')
    ...
    <div class="main-content-inner">
        ...
        <div class="main-content-wrap">
            ...
            <!-- form-add-product -->
            <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{route('artist.product.store')}}" >
                @csrf
                <div class="wg-box">
                    ...
                    <div class="gap22 cols">
                        ...
                        @else
                            <p class="alert alert-danger">Artist data is missing or invalid.</p>
                        @endif
                ...
                <div class="wg-box">
                        ...
                        <!-- Main Image -->
                        <fieldset>
                            <div class="body-title mb-30">Upload the main image <span class="tf-color-1">*</span></div>
                     ...
                     <div class="cols gap22">
                        ...
                        <fieldset class="regular_price">                                                
                            ...
                            <input class="mb-30" type="text" placeholder="Enter regular price" name="regular_price" tabindex="0" value="{{old('regular_price')}}" aria-required="true" required="">                                              
                        </fieldset>
                        @error("regular_price") <span class="alert alert-danger text-center">{{$message}}</span> @enderror

                         <!-- Quantity Field -->
                         <fieldset class="quantity">
                            <div class="body-title mb-30">Quantity</div>
                            <input readonly class="mb-30" type="text" name="quantity" value="{{ old('quantity', 1) }}" tabindex="0" aria-required="true">
                        </fieldset>
                        @error("quantity")
                    ...
                    <div class="cols gap30">
                        <!-- Certificate of Authenticity -->
                        <fieldset class="COA">
                            <label class="body-title mb-30" for="COA">Certificate of Authenticity</label>
                            <div class="select">
                                <select id="COA" name="COA" class="custom-dropdown">
                        ...
                        <fieldset class="framed">
                            <label class="body-title mb-30" for="framed">Is Framed</label>
                            <div class="select">
                                <select id="framed" name="framed" class="custom-dropdown">
                                    <option value="0">No</option>
                                    <option value="1">Yes</option>
                                </select>
                            </div>
                        ...
                        <fieldset class="signature">
                            <label class="body-title mb-30" for="signature">Has Signature</label>
                            <div class="select">
                                <select id="signature" name="signature" class="custom-dropdown">
                                    <option value="0">No</option>
                                    <option value="1">Yes</option>
                                </select>
                            </div>
