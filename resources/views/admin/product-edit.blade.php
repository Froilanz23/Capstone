        ...
        <div class="main-content-wrap">
                ...
                <h5>BASIC INFORMATION</h5>
                    ...
                    <div class="gap22 cols">
                        ...
                        <fieldset class="artist_id">
                            <div class="body-title mb-10">Artists<span class="tf-color-1">*</span></div>
                            <div class="select">
                                <select class="" name="artist_id">
                                    <option value="" disabled selected>Choose artist</option>
                                    @foreach ($artists as $artist)
                                    <option value="{{$artist->id}}" {{$product->artist_id == $artist->id ? "selected":""}}>{{$artist->name}}</option>
                                    @endforeach                                      
                                </select>
                            </div>
                        </fieldset>
            ...
            <div class="wg-box">
                    ...
                    <div class="cols gap22">
                        ...
                        <!-- COA -->
                        <fieldset class="COA">
                            <div class="body-title mb-10">Certificate of Authenticity</div>
                            <div class="select mb-10">
                                <select name="COA">
                        ...
                        <fieldset class="framed">
                            <div class="body-title mb-10">Framed</div>
                            <div class="select mb-10">
                                <select name="framed">
                        ...
                        <fieldset class="signature">
                            <div class="body-title mb-10">Signature</div>
                            <div class="select mb-10">
                    ...
                    <!-- end of FEATURED, COA, FRAMED, SIGNATURE -->
