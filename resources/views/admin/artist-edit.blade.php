    ...
    <div class="main-content-wrap">
        <div class="flex items-center flex-wrap justify-between gap20 mb-27">
            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li>
                    <a href="{{ route('admin.artists') }}"><div class="text-tiny">Artists</div></a>
                </li>
                <li><i class="icon-chevron-right"></i></li>
                <li>
        ...
        <!-- Edit Form -->
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{ route('admin.artist.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method("PUT")
                ...
                <fieldset class="mobile">
                    ...
                    <input class="flex-grow" type="text" placeholder="Edit your mobile" name="mobile" tabindex="0" 
