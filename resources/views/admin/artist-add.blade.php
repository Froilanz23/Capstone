...
<div class="main-content-inner">
    <div class="main-content-wrap">
        ...
        @endif
        <div class="wg-box">
            <form class="tf-section-1 form-new-product form-style-1" action="{{route('admin.artist.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <fieldset class="mobile">
                    ...
                    <input class="flex-grow" type="text" placeholder="Enter your mobile here" name="mobile"
